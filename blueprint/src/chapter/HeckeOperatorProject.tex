...
\begin{lemma} $GL_2(\calO_v)$ is a compact open subgroup of $GL_2(K_v)$.
  \lean{IsDedekindDomain.GL2.localFullLevel.isOpen}
  \lean{IsDedekindDomain.GL2.localFullLevel.isCompact}
  \label{nolean-compactopen-GL2}
  \leanok
\end{lemma}
\begin{proof}
  \leanok
  \uses{M2.localFullLevel.isOpen, M2.localFullLevel.isCompact, Submonoid.units_isOpen, Submonoid.units_isCompact}
...
\begin{lemma}
  \lean{TotallyDefiniteQuaternionAlgebra.WeightTwoAutomorphicForm.HeckeOperator.Local.bijOn_leftCoset_doubleCoset}
  \label{bijOn_leftCoset_doubleCoset}
  \leanok
...
so lemma~\ref{bijOn_leftCoset_doubleCoset} applies.
...
\begin{theorem}
  \lean{TotallyDefiniteQuaternionAlgebra.WeightTwoAutomorphicForm.HeckeAlgebra.instCommRing}
